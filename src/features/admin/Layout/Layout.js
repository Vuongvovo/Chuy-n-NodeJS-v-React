            ...
            <Layout>
                <Sider trigger={null} collapsible collapsed={state.collapsed}>
                    ...
                    <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
                        ...
                        <Menu.Item key="4" icon={state.collapsed === true ? <span className="fas fa-check"></span> : <span className="fas fa-check mr-2"></span>}>
                        ...
                        <Menu.Item key="5" icon={state.collapsed === true ? <span className="fas fa-code-branch" ></span> : <span className="fas fa-code-branch mr-2"></span>}>
                            <Link to={`${match.url}/typeWork`}>Loại công việc</Link>
                        </Menu.Item>
                        <Menu.Item key="6" icon={state.collapsed === true ? <span className="fas fa-briefcase" ></span> : <span className="fas fa-briefcase mr-2"></span>}>
                            <Link to={`${match.url}/work`}>Công việc</Link>
                        </Menu.Item>
                        <Menu.Item key="7" icon={state.collapsed === true ? <span className="fas fa-layer-group" ></span> : <span className="fas fa-layer-group mr-2"></span>}>
                            <Link to={`${match.url}/formCV`}>Form CV</Link>
                        </Menu.Item>
                        <Menu.Item key="8" icon={state.collapsed === true ? <span className="fas fa-address-book" ></span> : <span className="fas fa-address-book mr-2"></span>}>
